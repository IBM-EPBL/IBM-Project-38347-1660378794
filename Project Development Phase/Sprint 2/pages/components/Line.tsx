...
export default function Line() {
  ...
  return (
    ...
    >
      ...
      >
        The Y-axis displays the number of stocks in demand and the X-axis
        displays the dates of transaction. The graph illustrates the day to dsy
        demand of products depending upon the customer&apos;s ongoing needs and
        trends. This will facilitate the admin to have a clear and ease of
        knowledge about the product&apos;s need for the customer depending upon
        the imerging trend.{" "}
      </div>
    </div>
  );
