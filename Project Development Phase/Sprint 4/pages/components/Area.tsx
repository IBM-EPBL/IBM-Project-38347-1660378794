...
export default function Bar() {
  ...
  return (
    ...
    >
      ...
      >
        The Y-axis displays the number of stocks and the X-axis displays the
        dates of transaction. This graph illustrates the day to day stock
        supplies with the customer. This will facilitate the admin to have a
        clear and ease of knowledge about the day to day supply of the products.
      </div>
    </div>
  );
}
